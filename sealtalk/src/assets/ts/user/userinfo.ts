    ...
    function($scope: any, $state: angular.ui.IStateService, mainServer: mainServer, mainDataServer: mainDataServer, conversationServer:conversationServer) {
        ...
        $scope.logout = function() {
            //mainServer.user.logout().success(function() {
                ...
                webimutil.CookieHelper.removeCookie("loginusertoken");//清除ry的token
                webimutil.CookieHelper.removeCookie("loginselftoken");//清除ch的token
               // webimutil.CookieHelper.removeCookie("loginuserid");//清除ch的token
